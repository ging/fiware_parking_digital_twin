...
./spark-3.1.2/bin/docker-image-tool.sh -r fiwareusr -t $1 -f spark-3.1.2/kubernetes/dockerfiles/spark/Dockerfile build
./spark-3.1.2/bin/docker-image-tool.sh -r fiwareusr -t $1 -f spark-3.1.2/kubernetes/dockerfiles/spark/Dockerfile push
...
./spark-3.1.2/bin/spark-submit \
    ...
    --conf "spark.kubernetes.container.image=fiwareusr/spark:$1" \
